    ...
    <div className="flex h-screen bg-white font-sans text-black overflow-hidden relative">
      ...
      {createdMeeting && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white p-8 rounded-2xl border-[3px] border-black shadow-[8px_8px_0px_0px_#000] max-w-md w-full mx-4">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex gap-4">
                <div className="flex-1">
                  ...
                  <div className="bg-[#f0fdf4] border-[3px] border-black rounded-xl p-3 font-bold text-lg text-black text-center tracking-widest shadow-[3px_3px_0px_0px_#000]">
                    {createdMeeting.id}
                  </div>
                </div>
                <div className="flex-1">
              ...
              <div>
                ...
                <select className="w-full bg-white border-[3px] border-black rounded-xl p-3 font-bold text-sm text-black shadow-[3px_3px_0px_0px_#000] focus:outline-none cursor-pointer">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input 
                    ...
                    className="flex-1 bg-white border-[3px] border-black rounded-xl px-3 py-2 text-sm font-bold text-black focus:outline-none shadow-[3px_3px_0px_0px_#000]"
                  />
                  <button 
                    onClick={() => {
                    ...
                    className="bg-black text-white border-[3px] border-black font-bold rounded-xl px-4 py-2 hover:bg-slate-800 transition-colors shadow-[3px_3px_0px_0px_#000] text-sm"
                  >
                    Send
                  </button>
                </div>
            ...
            <div className="flex gap-4 pt-4 border-t-[3px] border-black border-dashed">
              <button 
                onClick={() => setCreatedMeeting(null)}
                className="flex-1 py-3 bg-white border-[3px] border-black text-black font-bold rounded-xl hover:bg-slate-50 transition-colors shadow-[3px_3px_0px_0px_#000] text-sm"
              >
                Cancel
              </button>
              <button 
                onClick={() => navigate(`/meeting?id=${createdMeeting.id}&host=true&pwd=${createdMeeting.pwd}`)}
                className="flex-1 py-3 bg-[#008248] border-[3px] border-black text-white font-bold rounded-xl hover:bg-[#006e3d] transition-colors shadow-[3px_3px_0px_0px_#000] text-sm"
              >
                Start Session
              </button>
            </div>
      ...
      <PageTransition className="flex-1 flex flex-col h-full overflow-hidden">
        {/* Top Header */}
        <header className="px-10 py-6 border-b-[3px] border-black flex items-center justify-between bg-white z-20 shrink-0">
          <div className="relative w-96 group">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-black font-bold w-5 h-5" />
            <input 
              type="text" 
              placeholder="Search meetings..." 
              className="w-full bg-white border-[3px] border-black rounded-xl py-2 pl-12 pr-4 text-sm focus:outline-none focus:shadow-[4px_4px_0px_0px_#000] transition-all text-black placeholder:text-slate-500 font-bold"
            />
          </div>
          
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2 px-4 py-2 bg-white border-[3px] border-black text-black rounded-xl shadow-[3px_3px_0px_0px_#000]">
            ...
            <div className="relative">
              <div 
                ...
                className="w-11 h-11 flex items-center justify-center border-[3px] border-black rounded-xl cursor-pointer hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_0px_#000] transition-all bg-white relative"
              >
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-4 w-80 bg-white border-[3px] border-black rounded-2xl shadow-[8px_8px_0px_0px_#000] z-[100] overflow-hidden">
                  <div className="p-4 border-b-[3px] border-black bg-[#f0fdf4] flex justify-between items-center">
                  ...
                  <div className="max-h-80 overflow-y-auto">
                    <div className="p-4 border-b-[3px] border-black hover:bg-slate-50 cursor-pointer transition-colors bg-red-50">
                      <div className="flex gap-3">
                        <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center shrink-0 border-[2px] border-black">
                    ...
                    <div className="p-4 hover:bg-slate-50 cursor-pointer transition-colors">
                      <div className="flex gap-3">
                        <div className="w-8 h-8 rounded-full bg-[#008248]/10 flex items-center justify-center shrink-0 border-[2px] border-black">
            ...
            <div className="w-11 h-11 rounded-xl overflow-hidden border-[3px] border-black cursor-pointer shadow-[3px_3px_0px_0px_#000] bg-slate-100">
            ...
            <div className="flex-[2] space-y-10">
              ...
              <div className="neobrutal-card relative bg-white">
                <div className="relative z-10">
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border-[3px] border-black text-[10px] font-bold tracking-widest text-black mb-6 uppercase bg-white shadow-[3px_3px_0px_0px_#000]">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <button onClick={handleNewMeeting} disabled={isCreating} className="neobrutal-btn primary text-sm px-6 py-3">
                      ...
                      <div className="flex bg-white rounded-xl border-[3px] border-black shadow-[4px_4px_0px_0px_#000] overflow-hidden items-center">
                        <input 
                          type="text" 
                          placeholder="Meeting ID" 
                          value={joinId}
                          onChange={(e) => setJoinId(e.target.value)}
                          className="bg-transparent px-4 py-2 text-sm focus:outline-none w-32 font-bold text-black border-r-[3px] border-black"
                        />
                        <input 
                          type="password" 
                        ...
                        />
                        <button onClick={handleJoin} className="h-full px-5 py-2 bg-black text-white font-bold text-sm hover:bg-slate-800 transition-colors border-l-[3px] border-black">
                          Join
                        </button>
                      </div>
                  </div>
            ...
            <div className="flex-1 space-y-10">
              ...
              <div className="neobrutal-card !p-8 !bg-[#008248] text-white">
                <div className="flex items-center justify-between mb-8">
                  <div className="w-12 h-12 bg-white border-[3px] border-black rounded-xl flex items-center justify-center shadow-[4px_4px_0px_0px_#000]">
                    <Lock className="w-5 h-5 text-black" />
                  </div>
                  <span className="px-3 py-1 bg-white text-black border-[3px] border-black rounded-full text-[10px] font-bold uppercase tracking-widest shadow-[3px_3px_0px_0px_#000]">ZK-Verified</span>
                </div>
                ...
                <div className="bg-white border-[3px] border-black rounded-xl p-3 flex items-center justify-between shadow-[4px_4px_0px_0px_#000]">
